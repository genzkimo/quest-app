...
export const translations: Record<'ar' | 'fr' | 'en', TranslationDict> = {
 ...
 kycRequiredWarning: "يتطلب تفعيل حسابك رفع بطاقة الهوية وتوثيق الـ KYC لتأكيد الهوية للعمل ميدانياً.",
 uploadId: "رفع بطاقة الهوية الوطنية أو رخصة القيادة لإثبات الهوية",
 kycPendingStatus: "طلب التحقق من الهوية معلق قيد المراجعة",
 kycUnverifiedStatus: "حساب غير موثق - ارفع هويتك لتفعيل الحساب وبدء الأعمال",
 kycVerifiedStatus: "حساب معتمد موثق مع شارة الأمان الزرقاء",
 ...
 kycSubtitle: "ارفع بطاقتك لتصبح شريكاً موثقاً وتحصل على شارة الأمان الزرقاء لبدء المهام المحلية الكبرى",
 verifiedBadge: "شريك معتمد موثق",
 ...
 kycRequiredWarning: "La signature de contrats exige une identité de chasseur vérifiée (KYC).",
 ...
 kycVerifiedStatus: "Chasseur Licencié avec Badge d'Honneur Bleu",
 ...
 verifiedBadge: "Chasseur Certifié",
 ...
 kycRequiredWarning: "Signing neighborhood contracts requires a verified hunter card uploaded.",
 ...
 kycVerifiedStatus: "Verified Syndicate Fighter under Sky Blue security clearance",
 ...
 verifiedBadge: "Certified Hunter",
