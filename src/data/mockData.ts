...
export const INITIAL_CHALLENGES: Challenge[] = [
 ...
 {
 id: 'daily-1',
 title: { ar: 'كابتن الصباح الباكر ', fr: 'Lève-tôt ', en: 'Early Bird Captain ' },
 description: {
 ...
 {
 id: 'daily-5',
 title: { ar: 'خطوة التحقق الأمنية ', fr: 'Sûreté Initiale ', en: 'Security First step ' },
 description: {
...
export const OLD_INITIAL_BADGES: Badge[] = [
 ...
 {
 id: 'bronze-2',
 title: { ar: 'مستكشف الخرائط الحية ', fr: 'Géolocalisé ', en: 'Live Navigator ' },
 ...
 {
 id: 'bronze-16',
 title: { ar: 'الأمين المنضبط ', fr: 'Dévoué Honnête ', en: 'Sincere Hand ' },
 ...
 {
 id: 'bronze-18',
 title: { ar: 'كريم التنازل الأخلاقي ', fr: 'Accord Amiable ', en: 'Peace Ambassador ' },
 ...
 {
 id: 'silver-9',
 title: { ar: 'ملازم ومصلح المرافق ', fr: 'As de la Clé ', en: 'Handy Craftsman ' },
 ...
 {
 id: 'silver-11',
 title: { ar: 'منقذ الموعد المزدحم ', fr: 'Gardien d\'Heure ', en: 'Punctuality Wizard ' },
 ...
 {
 id: 'silver-15',
 title: { ar: 'مدافع رادع الاحتيال', fr: 'Défenseur Vigilant', en: 'Scam Shield Marshal' },
 ...
 {
 id: 'gold-4',
 title: { ar: 'رتبة الجنرال الذهبي', fr: 'Grand Général', en: 'General of Honor Rank' },
 ...
 description: { ar: 'نقرت مسح رادار الصيادين بنجاح ١٠0 مرة للعثور على الغنائم.', fr: 'Scannez le radar géographique plus de 100 fois.', en: 'Completed 100 successful high-precision area coordinate sweeps.' },
 ...
 {
 id: 'gold-10',
 title: { ar: 'المحكم الأمين للنزاعات', fr: 'Arbitre d\'Or', en: 'Golden Dispute Arbiter' },
 ...
 {
 id: 'ruby-2',
 title: { ar: 'حارس الإقليم والبلدة', fr: 'Gardien Sacré', en: 'Neighborhood Guardian' },
 ...
 description: { ar: 'ادفع واستهلك ٥,٠٠0 د.ج تراكمياً في رسوم استخدام المنصة لتأمين العقود.', fr: 'Consommez plus de 5 000 DA dans vos affectations.', en: 'Pay 5,000 DA cumulative platform usage fees.' },
